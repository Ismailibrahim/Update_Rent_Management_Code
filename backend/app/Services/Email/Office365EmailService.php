...
class Office365EmailService implements EmailServiceInterface
{
    ...
    public function send(string $to, string $subject, string $body, array $options = []): bool
    {
        try {
            ...
            Log::error('Office 365 email send failed: ' . $e->getMessage(), [
                'to' => $to,
                'subject' => $subject,
                'error' => $e->getMessage(),
            ]);
            ...
            Log::error('Office 365 email send error: ' . $e->getMessage(), [
                'to' => $to,
                'subject' => $subject,
                'error' => $e->getMessage(),
            ]);
    ...
    /**
     * Test the Office 365 SMTP connection.
     */
    public function testConnection(): bool
    {
        try {
            ...
            Mail::raw('This is a test email to verify Office 365 SMTP configuration.', function ($message) use ($testEmail) {
            ...
            Log::error('Office 365 connection test failed: ' . $e->getMessage());
    ...
    /**
     * Configure Laravel mail settings for Office 365.
     */
    protected function configureMail(): void
    {
        config([
            ...
            'mail.mailers.smtp' => [
                'transport' => 'smtp',
                'host' => $this->config['smtp_host'] ?? 'smtp.office365.com',
