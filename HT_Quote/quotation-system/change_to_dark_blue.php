...
$template = ServiceTermsTemplate::first();

$newContent = '<div style="font-family: Arial, sans-serif; color: #003366; font-size: 11px; line-height: 1.3;">
...
echo "Service terms template updated with dark blue color (#003366) for all text\n";
